...
export const day2Schedule: TimelineItem[] = [
  ...
  { time: "09:15-10:00", title: "Keynote 影片（選看）", type: "session", who: "Helper C", details: "「Empowering Women in HealthTech」播放，團隊可選擇觀看或繼續工作" },
  { time: "09:15-12:00", title: "方案精煉 + 簡報準備", type: "session", who: "團隊", details: "指導老師提供最後諮詢" },
  ...
  { time: "12:00-12:30", title: "評審抵達 + 說明", type: "setup", who: "Chuehan", details: "說明評分標準、流程、Q&A 方式" },
  { time: "12:00-13:00", title: "午餐", type: "break", who: "全體", details: "60 人教室。Helper C 同時載入所有簡報（勿打擾）。" },
  { time: "13:00-13:10", title: "評審介紹 + 格式說明", type: "pitch", who: "Chuehan MC", details: "介紹每位評審，說明 4 分鐘格式（3 min pitch + 30 sec Q&A + 30 sec buffer）" },
  { time: "13:10-13:54", title: "Block 1：Teams 1–11", type: "pitch", who: "Helper A (計時) + C (簡報)", details: "每隊 4 分鐘，1 位評審輪流提問" },
  { time: "13:54-14:02", title: "休息", type: "break", details: "8 分鐘" },
  { time: "14:02-14:46", title: "Block 2：Teams 12–22", type: "pitch", who: "Helper A + C", details: "同上" },
  { time: "14:46-14:54", title: "休息", type: "break", details: "8 分鐘" },
  { time: "14:54-15:38", title: "Block 3：Teams 23–33", type: "pitch", who: "Helper A + C", details: "同上" },
  { time: "15:38-15:46", title: "休息", type: "break", details: "8 分鐘" },
  { time: "15:46-16:26", title: "Block 4：Teams 34–42", type: "pitch", who: "Helper A + C", details: "最後一組，約 8-10 隊" },
  { time: "16:26-16:36", title: "評審回饋時間", type: "pitch", who: "全體評審", details: "評審分享整體觀察、建議（10 分鐘）" },
  { time: "16:36-16:50", title: "評分統計", type: "setup", who: "Helper B", details: "紙本評分表手動統計。同時進行大合照 + 自由交流。" },
  { time: "16:50-17:00", title: "頒獎 + 閉幕 + 合照", type: "critical", who: "Chuehan MC + Helper D", details: "公布第三名→第二名→第一名，頒發證書，感謝致詞，大合照" },
  { time: "17:00+", title: "撤場", type: "setup", who: "全體", details: "收拾器材、清潔場地、恢復原狀" },
];
