...
export const day2Schedule: TimelineItem[] = [
  ...
  { time: "13:00-13:10", title: "評審介紹 + 格式說明", type: "pitch", who: "Chuehan MC", details: "介紹每位評審，說明 5 分鐘格式（3 min pitch + 1.5 min Q&A + 0.5 min buffer）。評分標準：10 項指標，每項 0/1/2 分，共 20 分。" },
  { time: "13:10-14:05", title: "Block 1：Teams 1–11", type: "pitch", who: "Helper A (計時) + C (簡報)", details: "每隊 5 分鐘，1.5 分鐘 Q&A（評審輪流提問）" },
